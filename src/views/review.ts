    ...
    this.element.innerHTML = `
      <div class="review-screen-content">
        <div class="kiosk-app-bar">
          <button class="kiosk-back-btn" id="btn-review-back" type="button">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="19" y1="12" x2="5" y2="12"></line><polyline points="12 19 5 12 12 5"></polyline></svg>
            <span>CANCEL</span>
          </button>
          <div class="kiosk-app-bar-titles">
            <h2 class="kiosk-screen-title">Review Photos</h2>
            <p class="kiosk-screen-subtitle">Tap any photo you want to retake</p>
          </div>
        </div>
