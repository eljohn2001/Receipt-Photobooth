...
export function convertCanvasToEscPos(canvas: HTMLCanvasElement): Uint8Array {
  ...
  // Job Header: 32 NUL padding bytes to complete any stuck raster slice from prior sessions, DLE ENQ 1, ESC @ reset, ESC 3 0 line spacing
  chunks.push(new Uint8Array([
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x10, 0x05, 0x01,  // DLE ENQ 1 (Real-time request to clear printer print buffer)
  ...
  // Job Footer: Reset line spacing, feed paper past cutter/tear bar, cut paper cleanly, reset printer state, and append 64 NUL bytes to flush hardware FIFOs
  chunks.push(new Uint8Array([
    0x1B, 0x32,                  // ESC 2 (Reset line spacing to 1/6 inch default)
    0x0A, 0x0A, 0x0A, 0x0A, 0x0A, 0x0A, // Feed 6 lines (feeds receipt clear of paper slot)
    0x1D, 0x56, 0x01,            // GS V 1 (Partial paper cut)
    0x1B, 0x40,                  // ESC @ (Initialize printer for clean state)
    // 64 NUL trailing bytes to ensure ESC @ and GS V 1 are fully flushed through hardware transmit queues
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
